...
"%dotnet%" test --no-build /p:AltCover=true /p:AltCoverForce=true /p:AltCoverXmlReport=..\%targetdir%\coverage.opencover.xml /p:AltCoverCobertura=..\%targetdir%\coverage.cobertura.xml BusinessTest_NetCore2\BusinessTest_NetCore2.csproj
