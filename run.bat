...
"%reportGenerator%" -reports:%targetdir%\coverage.xml -reporttypes:HtmlInline -targetdir:%targetdir% -assemblyfilters:-xunit*;-AltCover*;-coverlet*;-FSharp.Core* -classfilters:-AutoGeneratedProgram
...
"%reportGenerator%" -reports:%targetdir%\coverage.cobertura.xml -reporttypes:HtmlInline -targetdir:%targetdir% -assemblyfilters:-xunit*;-AltCover* -classfilters:-AutoGeneratedProgram